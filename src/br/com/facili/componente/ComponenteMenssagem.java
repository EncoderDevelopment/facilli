	...
	public static void menssagem(final String messagem , final int gravidade , final int duracao , final int tipoDeMenssagem) {
		CCDirector.sharedDirector().getActivity().runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				case 1:
					llRoot.setBackgroundResource(R.drawable.toast_azul);
					break;
				case 2:
					llRoot.setBackgroundResource(R.drawable.toast_amarelo);
					break;
				case 3:
					llRoot.setBackgroundResource(R.drawable.toast_vermelho);
					break;
				}
				...
				toast.setGravity(gravidade, 0, 200); 
				toast.show();	
			}
		});
	}
